$(function(){
    ...
    new_element.setAttribute("src","js/change.js");// 在这里引入了a.js
    ...
    var playnum = 0;//已玩次数
    var status = 0;//玩家标识
    var flagwin = false;//是否中奖
    var flagfollow = false;//是否关注公众号
...
//开始测试按钮
    ...
    function click(){
        ...
        var select = $(this).find('p').children('span').html();
        // kaiguan();
        if(select==answer){
            $(this).find('img').attr({
                "src" : "img/14.png",
    ...
    function playgame(){
        ...
        num = Math.floor(Math.random()*26);//产生0~26的随机数，不包括26，即0~25
        songlist = list.slice(num,num+5);
        index = 0;
        xuhao = $(".tihao1>li");
        right = 0;//答对题的数目
        t;
    ...
    function render(data){
       ...
       <div class="title">
        ...
        <ul class="optionCont">
            <li>
                <div class="optionBox" data="${data.answer}">
                     <img src="" alt="" imgData="" class="option">
                </div>
                <p>&nbsp;&nbsp;&nbsp;A.&nbsp;&nbsp;&nbsp;<span class="option">${data.options[0]}</span></p>
            </li>
            <li>
                <div class="optionBox" data="${data.answer}">
                     <img src="" alt="" imgData="" class="option"> 
                </div>
                <p>&nbsp;&nbsp;&nbsp;B.&nbsp;&nbsp;&nbsp;<span class="option">${data.options[1]}</span></p>
            </li>
            <li>
                <div class="optionBox" data="${data.answer}">
                     <img src="" alt="" imgData="" class="option">
                </div>
                <p>&nbsp;&nbsp;&nbsp;C.&nbsp;&nbsp;&nbsp;<span class="option">${data.options[2]}</span></p>
            </li>
            <li>
                <div class="optionBox" data="${data.answer}">
                     <img src="" alt="" imgData="" class="option">
                </div>
                <p>&nbsp;&nbsp;&nbsp;D.&nbsp;&nbsp;&nbsp;<span class="option">${data.options[3]}</span></p>
            </li>
        </ul>
       `;
